 ...
 */
class Version20151211103051 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE receiver_has_observation ADD CONSTRAINT FK_68DD67EBA76ED395 FOREIGN KEY (user_id) REFERENCES User (id) ON DELETE SET NULL');
    }
