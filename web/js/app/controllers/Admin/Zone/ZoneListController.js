angular.module('app')
        ...
        .controller('ZoneListController', ['$scope', '$http', '$modal', '$filter', '$controller', function ($scope, $http, $modal, $filter, $controller) {
                $scope.params = {
                    entity: {
                        singular: 'zone',
                        plural: 'zones'
                    ...
                    routing: {
                        list: {
                            get: 'api_admin_get_zones'
                        },
                        home: 'admin_sentinelle_zone_list',
                        show: 'admin_sentinelle_zone_edit',
                        remove: 'api_admin_delete_zone',
                        get: 'api_admin_get_zone'
                    }
                };
                ...
                $scope.openDeleteModal = function ($index, entity) {
                    var $instance = $modal.open({
                        controller: 'ModalZoneRemoveController',
                        templateUrl: 'modal.remove-zone.html',
                        resolve: {
                            params: function () {
                                return $scope.params;
                            },
