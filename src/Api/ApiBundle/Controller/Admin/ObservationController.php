...
class ObservationController extends ApiRestController
{
    ...
    public function getObservationsAction()
    {
        ...
        $array = array();
        $arrayList = array();
        if ($this->get('session')->has('naturapass_admin/listing')) {
            $request = $this->get('session')->get('naturapass_admin/listing');
            $filter = array(
        ...
        $request = $this->get('session')->set('naturapass_admin/array_observation', $array);
        $manager->flush();
     ...
     *
     * GET /admin/observations/{card}/excel
     *
     * @param String $card
     * @return \FOS\RestBundle\View\View
     *
    ...
    {
        if ($this->get('session')->has('naturapass_admin/array_observation')) {
            $session = $this->get('session')->get('naturapass_admin/array_observation');
