...
/**
 * Class GroupJoinRefusedNotification
 * @package NaturaPass\NotificationBundle\Entity\Group
 *
 * @ORM\Entity
 */
class GroupJoinRefusedNotification extends AbstractNotification
{

    const TYPE = 'group.join.refused';
    ...
    {
        return array(//            'grouptag' => $this->group->getGrouptag()
        );
    }
