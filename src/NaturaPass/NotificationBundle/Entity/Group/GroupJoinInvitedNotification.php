...
/**
 * Class GroupJoinInvitedNotification
 * @package NaturaPass\NotificationBundle\Entity\Group
 *
 * @ORM\Entity
 */
class GroupJoinInvitedNotification extends AbstractNotification
{

    const TYPE = 'group.join.invited';
    ...
    public function __construct(Group $group)
    {
        parent::__construct(array(
            'route' => 'naturapass_group_invited',
        ));
