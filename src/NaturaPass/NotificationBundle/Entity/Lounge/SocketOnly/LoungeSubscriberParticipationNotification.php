...
/**
 * Class LoungeSubscriberParticipationNotification
 * @package NaturaPass\NotificationBundle\Entity\Lounge\SocketOnly
 */
class LoungeSubscriberParticipationNotification extends AbstractNotification implements SocketPoolNotification
{
    ...
    public function __construct(Lounge $lounge, LoungeUser $subscriber)
    {
        parent::__construct(array(
            ...
            'type' => 'lounge.user_participation',
            'persistable' => false,
            'socket' => array(
                'enabled' => true,
                'event_name' => 'api-lounge:participation'
            ),
            'push' => array(
                'enabled' => false
            )
    ...
    {
        return array(
            '%sender%' => $this->subscriber->getUser()->getFullName()
        );
    }
