...
/**
 * Class LoungeJoinAcceptedNotification
 * @package NaturaPass\NotificationBundle\Entity\Lounge
 *
 * @ORM\Entity
 */
class LoungeJoinRefusedNotification extends AbstractNotification
{

    const TYPE = 'lounge.join.refused';
    ...
    public function __construct(Lounge $lounge)
    {
        parent::__construct(array(
            'route' => 'naturapass_lounge_homepage',
        ));
    ...
    {
        return array(//            'loungetag' => $this->lounge->getLoungetag()
        );
    }
